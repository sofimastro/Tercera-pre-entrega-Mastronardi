...
# Vista para insertar un curso (vinculada al formulario de inserción de cursos)
def insertar_curso(request):
    if request.method == 'POST':
        ...
        form = CursoForm()
    return render(request, 'mi_app/insertar_curso.html', {'form': form})
...
def buscar_curso(request):
    ...
    return render(request, 'mi_app/buscar_curso.html', {'form': form, 'cursos': cursos})
